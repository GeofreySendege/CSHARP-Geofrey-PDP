...
namespace Exercise_Array_list__Exercise1
{
	internal class Program
	{
		...
		public static void SortListOfNumbers()
		{
			...
			while (true)
			{
				// here we enter all 5 five numbers at the same time. And output onto a single line as well.
				...
				//var number = int.Parse(numbersString);   //  check if the list contains the number before adding it to the list 
